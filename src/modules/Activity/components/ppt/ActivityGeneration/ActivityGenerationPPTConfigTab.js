...
import styles from "./ActivityGenerationPPTConfigTab.module.css";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faCheckCircle } from "@fortawesome/free-solid-svg-icons";

const ActivityGenerationPPTConfigTab = ({
  data,
  summary,
  instructions,
  setInstructions,
  ...
  <>
      ...
      <div className={styles.dataRow}>
        <div className={styles.dataCol}>
          ...
          <div className={styles.dataValue}>
            {/* Mostrar duración como "X Slides" */}
            {data.numSlides
              ? `${data.numSlides} Slides`
              : data.duration
              ? `${data.duration} Slides`
              : "-"}
          </div>
        </div>
        <div className={styles.dataCol}>
    ...
    <div className={styles.instructionsContainer}>
      <div className={styles.instructionsTitle}>Instrucciones adicionales</div>
      <textarea
        className={styles.instructionsTextarea}
        placeholder="Introduce instrucciones adicionales para la presentación aquí..."
        value={instructions}
...
export default ActivityGenerationPPTConfigTab;
